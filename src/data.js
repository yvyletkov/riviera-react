...
export const singlePromotionPages = {
    barhatnyiSezon: {
        bannerImg: barhatniiSeasonBannerImg,
        title: ['Бархатный', 'сезон'],
        description: 'Отель Riviera Sunrise Resort & SPA предлагает Вам продлить лето и неспеша погрузиться в мир осенней гармонии, со скидкой 20% по акции «Бархатный сезон».',
