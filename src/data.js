...
export const infrastructurePagesData = {
    restaurants: {
        bannerData: {
         ...
         restaurantsContent: [
             [
                 {name: "Велотренажер горизонтальный", description: "В ресторане «The Grilled» ежедневно накрывается  завтрак, обед и ужин европейской кухни в формате «Шведский стол». Наслаждайтесь разнообразием меню и большим выбором горячих и холодных блюд, легких закусок, молочных продуктов, горячих"},
                 [
             ...
             [
                 {name: "Вертикальная тяга", description: "Ресторан «Tavrika» спешит побаловать своих гостей русско-французской кухней от профессионального шеф-повара Максима Сысоева. Tavrika идеально подходит для закрытого обеда или ужина, а также для проведения праздничного мероприятия. Меню составляется, учитывая все пожелания гостей."},
                 [
                     {img: classic2img, name:'ресторан'},
                     {img: classic3img, name:'ресторан'},
                     {img: classic1img, name:'ресторан'},
             ...
             [
                 {name: "Скамья для нижней части спины", description: "Ресторан «La Veranda» расположен на белокаменной веранде исторического корпуса Классик, откуда открывается прекрасный вид на Черное море и парк отеля. В итальянское меню ресторана входят блюда из местных продуктов, старательно отобранных бренд-шефом Андреем Поляшовым.Обширная винная карта, представленная знаменитыми винзаводами: Массандра, Инкерман, Сатера ТМ «Esse», а также европейские и южноамериканские вина."},
                 [
                     {img: classic2img, name:'ресторан'},
                     {img: classic3img, name:'ресторан'},
                     {img: classic1img, name:'ресторан'},
             ...
             [
                 {name: "Ярик", description: "Лобби-бар «Mangup» — идеальное место для проведения встреч и непринужденного общения. Комфортно организованное пространство, удобная мебель, внимательное обслуживание и отличный сигнал Wi-Fi – прекрасное место для отдыха. Баре Вам всегда предложат ароматный кофе, элитные сорта виски и Крымские вина."},
                 [
                     {img: classic2img, name:'ресторан'},
                     {img: classic3img, name:'ресторан'},
                     {img: classic1img, name:'ресторан'},
             ...
             [
                 {name: "Водила", description: "Лобби-лаунж — место для спокойного общения.  Здесь Вы всегда сможете продегустировать мягкое крымское шампанское.\n" +
             ...
             [
                 {name: "Ярик", description: "Бар находится прямо в воде, в одном из открытых бассейнов аква-зоны отеля. В жаркий летний день Вы сможете освежиться прохладными напитками, даже не выходя из бассейна."},
                 [
                     {img: classic2img, name:'ресторан'},
                     {img: classic3img, name:'ресторан'},
                     {img: classic1img, name:'ресторан'},
             ...
             [
                 {name: "Ярик", description: "«Мангал в саду» – это место для ценителей нежного, сочного, ароматного мяса, приготовленного на огне. Особенным шиком и ярким, сочным дополнением станут пряности и соусы, которые мы используем в процессе готовки. Взрыв вкуса обеспечен!"},
                 [
                     {img: classic2img, name:'ресторан'},
                     {img: classic3img, name:'ресторан'},
                     {img: classic1img, name:'ресторан'},
             ...
             [
                 {name: "Ярик", description: "Близится торжество? День рождения, мальчишник, девичник? Караоке-бар «Green Stage» идеально подходит, чтобы отметить любой праздник в компании близких друзей, за исполнением любимых композиций. Бар может быть полностью закрыт под Ваше мероприятие"},
                 [
                     {img: classic2img, name:'ресторан'},
                     {img: classic3img, name:'ресторан'},
                     {img: classic1img, name:'ресторан'},
