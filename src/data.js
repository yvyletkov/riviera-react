    ...
    restaurants: {
        ...
        restaurantsContent: [
            [
                {
                    name: "Шведский стол",
                    description: "В ресторане «The Grilled» ежедневно накрывается  завтрак, обед и ужин европейской кухни в формате «Шведский стол». Наслаждайтесь разнообразием меню и большим выбором горячих и холодных блюд, легких закусок, молочных продуктов, горячих",
            ...
            [
                {
                    name: "Lobby Lounge",
                    description: "Лобби-лаунж — место для спокойного общения.  Здесь Вы всегда сможете продегустировать мягкое крымское шампанское.\n" +
