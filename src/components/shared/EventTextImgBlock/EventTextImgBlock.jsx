        ...
        <div className={s.wrapper}>
            <div className={s.container}>
                ...
                <div className={s.textContent}>
                    ...
                    <p>
                        {forWedding && <h5><b>Молодожёнов ждёт:</b></h5>}
                            ...
                            {listArray.length ? <ul>{listArray.map((item, index) => <li key={index}>{item}</li>)}</ul> : <Button text={'Узнать подробоности'} onClick={() => setPopupOpen(true)} style={window.matchMedia("(max-width: 768px)").matches ? {} : {width: '220px'}}/> }
                    </p>
                ...
                <PopupContactForm popupOpen={popupOpen} setPopupOpen={setPopupOpen}
                                  ...
                                  submitBtnText='Узнать подробоности'
