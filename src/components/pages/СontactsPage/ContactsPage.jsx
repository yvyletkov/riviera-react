                        ...
                        <div className={s.topRow}>
                            ...
                            <div className={s.textContent}>
                                ...
                                <p>Воспользуйтесь услугой трансфер, заказать вы можете по телефону <b><a
                                    href="tel:8 800 550 98 24" target={'_blank'}>8 800 550 98 24</a></b>
                                </p>
                        ...
                        <div className={s.flexWrapper}>
                            ...
                            <div className={s.col}>
                                ...
                                <div className={s.contactsItem}>
                                    ...
                                    <p><a target={'_blank'}
                                        ...
                                        <span><a style={{whiteSpace: 'nowrap'}} href="tel:8 800 550 98 24">8 800 550 98 24</a></span>
                                    </p>
                                </div>
                            ...
                            <div className={s.col}>
                                ...
                                <div className={s.contactsItem}>
                                    ...
                                    <div className={s.smallDesc}>Услуги предоставляются на основании лицензии на осуществление медицинской
