    ...
    return <>
        ...
        <section className='section'>
            <EventTextImgBlock subtitle='Для Вас' title='Лучший день' img={textImgBlockImg}
                               ...
                               forWedding={false}
                               listArray={[
                                   'веселая атмосферная вечеринка с дискотекой и фейерверком,',
                                   'время с друзьями в СПА, купание в бассейнах и в море,',
                                   'уединенный романтический стиль празднования,',
                                   'праздник дома и угощения от профессионального шефа',
                                   'cкидка на меню а ля карт и проживание 15% для именниника в дату Дня Рождения и неделю после при предъявлении документа',
                                   'Аренда барбекю площадки в соответствии с прайсом по сезону, скидка 15%',
                                   'Скидка на СПА-процедуры 10%']}
                               additionally={'*Скидка не суммируется с другими акциями'}/>
        </section>
        ...
        <section className="section">
            <FoodBlock title={'ИМЕНИННИКА'}
                       subtitle={'Бонусы'}
                       listArray={[
                           'Во время ужина предоставляется десерт и поздравление от команды ресторана/отеля',
                           'При проживании предоставляется комплемент в номер (шампанское, 2 фужера, конфеты, фруктовая тарелка)',
                           'Бесплатный поздний выезд до 15:00</br></br>*при наличии номеров']}
                       hashtag={'#деньрождениявривьере'}/>
        </section>
                    ...
                    <div className={s.grid}>
                        ...
                        <div className={s.textBlock}>
                            <div className={s.textContent}>
                                ...
                                <ContactForm submitBtnText={'Получить материалы для принятия решения'} formName={`Форма "Вам предстоит легкое решение" (скачать коммерческое предложение)`} withPhone
                                             swalText={'мы отправим всю необходимую информацию на указанную Вами почту в самое ближайшее время!'}/>
