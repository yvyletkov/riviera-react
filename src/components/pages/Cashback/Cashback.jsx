...
import beach from "../../../img/home-page/textimg.jpg"
        ...
        <div className="cashback-terms">
            <div className="cashback-terms__grid">
                ...
                <div className="cashback-terms__text-block">
                    ...
                    <ul>
                        <li>Быть участником программы лояльности держателей карты «Мир».
                            Чтобы вступить, зарегистрируйтесь на сайте «Мира».
                        </li>
                        <li>Бронирование должно быть сделано на даты с 18 марта по 15 июня
                            (в этот период необходимо оплатить поездку).
                        </li>
                        <li>Путешествие должно завершиться до 30 июня 2021 года включительно.</li>
                        <li>Стоимость путевки может быть любой. Ограничений на минимальную сумму нет.</li>
                        <li>Продолжительность проживания составляет не менее 2 ночей.
                        </li>
                        <li>Акция действует до 15 июня.</li>
                    </ul>
                </div>
        ...
        <div className="cashback-compensation">
            <div className="cashback-compensation-grid">
                ...
                <div className="cashback-compensation__text-block">
                    ...
                    <p>Производится 100% предоплата услуги на официальном сайте, с использованием платежной системы Мир, по карте любого банка.</p>
                    <p>Получение компенсации производится на карту МИР, с которой была произведена оплата.</p>
                    <ul>
                        <li>Возвращается 20% от стоимости бронирования, но не более 20 тысяч рублей</li>
                        <li>Получение компенсации производится на карту Мир, с которой была произведена оплата в течении 5 дней с момента оплаты.</li>
                    </ul>
                    <p className="bottom">Бронировать можно несколько раз с одной карты, но максимальный кэшбэк на одну карту составит 20 000 рублей.</p>
